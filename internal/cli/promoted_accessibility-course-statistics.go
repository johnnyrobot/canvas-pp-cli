...
func newAccessibilityCourseStatisticsPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "accessibility_course_statistics", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
