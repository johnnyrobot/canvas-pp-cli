...
func newLtiResourceLinksGetLtiResourceLinks2Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().BoolVar(&flagIncludeDeleted, "include-deleted", false, "Include deleted resource links in search. Default is false.")
