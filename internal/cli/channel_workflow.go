...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  canvas-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"account_calendars", "account_domain_lookups", "accounts", "accounts-manually-created-courses-account", "appointment_groups", "calendar_events", "conversations", "conversations-find-recipients", "courses", "epub_exports", "favorites", "favorites-courses", "grade_change_log", "groups", "media_objects", "media_objects-media-attachments", "planner", "planner-overrides", "planner-planner-notes", "search_resource", "users"}
			totalSynced := 0
