...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Canvas",
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fmt.Fprintln(w, "  export CANVAS_ACCESS_TOKEN=\"your-token-here\"")
			if !launch {
				return nil
			}
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if envStillSet == "" && os.Getenv("CANVAS_ACCESS_TOKEN") != "" {
				envStillSet = "CANVAS_ACCESS_TOKEN"
			}
