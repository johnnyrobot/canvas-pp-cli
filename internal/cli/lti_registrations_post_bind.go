...
func newLtiRegistrationsPostBindCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyWorkflowState, "workflow-state", "", "The desired state for this registration/account binding. Allowed values: on, off")
