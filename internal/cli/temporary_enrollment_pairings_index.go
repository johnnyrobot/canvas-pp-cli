...
func newTemporaryEnrollmentPairingsIndexCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().BoolVar(&flagIncludeDeleted, "include-deleted", false, "If true, include deleted pairings in the response. Defaults to false.")
