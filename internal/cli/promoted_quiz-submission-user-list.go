...
func newQuizSubmissionUserListPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if bodyConversations != "" {
				body["conversations"] = bodyConversations
			}
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "quiz_submission_user_list", data, "")
			}
	...
	cmd.Flags().StringVar(&bodyConversations, "conversations", "", "- Body and recipients to send the message to.")
