...
func newEportfoliosModerateAllCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodySpamStatus, "spam-status", "", "The spam status for all the ePortfolios Allowed values: marked_as_spam, marked_as_safe")
