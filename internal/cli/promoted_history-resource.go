...
func newHistoryResourcePromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "history_resource", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
