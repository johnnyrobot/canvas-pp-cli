...
func newQuizIpFiltersPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "quiz_ip_filters", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
