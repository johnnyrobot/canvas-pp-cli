...
func newApiTokenScopesPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "api_token_scopes", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
	...
	cmd.Flags().StringVar(&flagGroupBy, "group-by", "", "The attribute to group the scopes by. By default no grouping is done. Allowed values: resource_name")
