...
func newPollsubmissionsGetPollSubmissionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "pollsubmissions", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
