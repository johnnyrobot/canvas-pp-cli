...
func newQuizReportsGetReports2Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagInclude, "include", "", "Whether the output should include documents for the file and/or progress objects associated with this report.")
