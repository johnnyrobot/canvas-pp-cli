...
func newQuizSubmissionQuestionsGetFormattedAnswerCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagAnswer != "" {
				params["answer"] = formatCLIParamValue(flagAnswer)
			}
	...
	cmd.Flags().StringVar(&flagAnswer, "answer", "", "no description")
