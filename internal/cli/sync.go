...
func syncResourceSinceParam(resource string) string {
	...
	case "calendar_events":
		return "start_date"
	case "grade_change_log":
		return "start_time"
	case "planner":
		return "start_date"
	case "planner-planner-notes":
		return "start_date"
	}
	return ""
}
...
func defaultSyncResources() []string {
	return []string{
		...
		"accounts",
		"accounts-manually-created-courses-account",
		"appointment_groups",
		"calendar_events",
		"conversations",
		...
		"groups",
		"media_objects",
		"media_objects-media-attachments",
		"planner",
		"planner-overrides",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"account_calendars":      "/api/v1/account_calendars",
		"account_domain_lookups": "/api/v1/accounts/search",
		"accounts":               "/api/v1/accounts",
		"accounts-manually-created-courses-account": "/api/v1/manually_created_courses_account",
		"appointment_groups":                        "/api/v1/appointment_groups",
		"calendar_events":                           "/api/v1/calendar_events",
		"conversations":                             "/api/v1/conversations",
		"conversations-find-recipients":             "/api/v1/conversations/find_recipients",
		"courses":                                   "/api/v1/courses",
		"epub_exports":                              "/api/v1/epub_exports",
		"favorites":                                 "/api/v1/users/self/favorites/groups",
		"favorites-courses":                         "/api/v1/users/self/favorites/courses",
		"grade_change_log":                          "/api/v1/audit/grade_change",
		"groups":                                    "/api/v1/users/self/groups",
		"media_objects":                             "/api/v1/media_objects",
		"media_objects-media-attachments":           "/api/v1/media_attachments",
		"planner":                                   "/api/v1/planner/items",
		"planner-overrides":                         "/api/v1/planner/overrides",
		"planner-planner-notes":                     "/api/v1/planner_notes",
		"search_resource":                           "/api/v1/search/all_courses",
		"users":                                     "/api/v1/users/self/course_nicknames",
	}
