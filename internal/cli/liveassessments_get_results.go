...
func newLiveassessmentsGetResultsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagUserId, "user-id", "", "If set, restrict results to those for this user")
